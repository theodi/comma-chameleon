...
describe("displayValidationMessages", function() {
  ...
  before(function() {
    ...
    it('should display validation results', function() {
      ...
      expect($('#message-panel div:eq(0)').html()).to.have.string('<h5>Inconsistent value</h5><p>The data in column 13 is inconsistent with others values in the same column.\n</p>')
      expect($('#message-panel div:eq(1)').html()).to.have.string('<h5>Inconsistent value</h5><p>The data in column 23 is inconsistent with others values in the same column.\n</p>')
